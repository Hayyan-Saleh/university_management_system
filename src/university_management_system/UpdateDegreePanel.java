...
public class UpdateDegreePanel extends JPanel implements ActionListener{
     UserData loggedUser;
    JLabel m1,m2,m3,m4,m5,m6;
    JTextField t1,t2,t3,t4,t5,t6;
    JButton RefreshDegreesButton;
    JTable degreesTable;
    ...
    public UpdateDegreePanel(UserData loggedUser) {
    ...
    public void showFrame() {
        ...
        RefreshDegreesButton=new JButton("Refresh Degrees");
        RefreshDegreesButton.setBounds(430, 315, 150, 25);
        RefreshDegreesButton.setFocusPainted(false);
        RefreshDegreesButton.setBorder(BorderFactory.createLineBorder(Color.DARK_GRAY));
        RefreshDegreesButton.setBackground(Color.DARK_GRAY);
        RefreshDegreesButton.setForeground(Color.WHITE);
        RefreshDegreesButton.addActionListener(this);
        add(RefreshDegreesButton);
        ...
        try{degreesTable.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                String[] degrees=databases.DegreeDatabase.getDegreesById(rowId);
                t1.setText(degrees[0]);
                t2.setText(degrees[1]);
                t3.setText(degrees[2]);
                t4.setText(degrees[3]);
                t5.setText(degrees[4]);
                t6.setText(degrees[5]);
    ...
    public void actionPerformed(ActionEvent e) {
       ...
       String d4=t4.getText();
       String d5=t5.getText();
       String d6=t6.getText();
       if(d1!=null &&! d1.equals("")&&d2!=null &&! d2.equals("")&&d3!=null &&! d3.equals("")&&d4!=null &&! d4.equals("")&&d5!=null &&! d5.equals("")&&d6!=null &&! d6.equals(""))
        {  databases.DegreeDatabase.updateDegree(new String[]{d1,d2,d3,d4,d5,d6}, rowId);
